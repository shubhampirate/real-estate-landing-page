        ...
        <form style={{ padding: '30px 0 0 0' }}>
          <div style={{ display: 'flex', margin: '32px 0' }}>
            <div style={{ width: '48%', marginRight: '4%' }}>
              <div style={{ width: '100%', height: '40px', position: 'relative' }}>
                <input type="text" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', borderBottom: '2px solid rgba(0,0,0, 0.12)' }} />
                <label style={{ position: 'absolute', pointerEvents: 'none', bottom: '10px', fontSize: '16px', transition: 'all 0.3s ease' }}>First Name</label>
            ...
            <div style={{ width: '48%' }}>
              <div style={{ width: '100%', height: '40px', position: 'relative' }}>
                <input type="text" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', borderBottom: '2px solid rgba(0,0,0, 0.12)' }} />
                <label style={{ position: 'absolute', pointerEvents: 'none', bottom: '10px', fontSize: '16px', transition: 'all 0.3s ease' }}>Last Name</label>
                <div style={{ position: 'absolute', bottom: '0', height: '2px', width: '100%' }}>
                  <div style={{ position: 'absolute', content: '', height: '2px', width: '100%', background: '#3498db', transform: 'scaleX(0)', transformOrigin: 'center', transition: 'transform 0.3s ease' }}></div>
                </div>
              </div>
          ...
          <div style={{ display: 'flex', margin: '32px 0' }}>
            <div style={{ width: '48%', marginRight: '4%' }}>
              <div style={{ width: '100%', height: '40px', position: 'relative' }}>
                <input type="text" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', borderBottom: '2px solid rgba(0,0,0, 0.12)' }} />
                <label style={{ position: 'absolute', pointerEvents: 'none', bottom: '10px', fontSize: '16px', transition: 'all 0.3s ease' }}>Email Address</label>
                <div style={{ position: 'absolute', bottom: '0', height: '2px', width: '100%' }}>
                  <div style={{ position: 'absolute', content: '', height: '2px', width: '100%', background: '#3498db', transform: 'scaleX(0)', transformOrigin: 'center', transition: 'transform 0.3s ease' }}></div>
                </div>
              </div>
            ...
            <div style={{ width: '48%' }}>
              <div style={{ width: '100%', height: '40px', position: 'relative' }}>
                <input type="text" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', borderBottom: '2px solid rgba(0,0,0, 0.12)' }} />
                <label style={{ position: 'absolute', pointerEvents: 'none', bottom: '10px', fontSize: '16px', transition: 'all 0.3s ease' }}>Website Name</label>
                <div style={{ position: 'absolute', bottom: '0', height: '2px', width: '100%' }}>
                  <div style={{ position: 'absolute', content: '', height: '2px', width: '100%', background: '#3498db', transform: 'scaleX(0)', transformOrigin: 'center', transition: 'transform 0.3s ease' }}></div>
                </div>
              </div>
          ...
          <div style={{ width: '100%', height: '70px', position: 'relative' }} className="textarea">
            <textarea rows="8" cols="80" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', resize: 'none', paddingTop: '10px' }}></textarea>
            <br />
            <label style={{ position: 'absolute', pointerEvents: 'none', bottom: '40px', fontSize: '16px', width: '100%', background: '#fff' }}>Write your message</label>
            <br />
            <div style={{ position: 'absolute', bottom: '0', height: '2px', width: '100%' }} className="underline">
              <div style={{ position: 'absolute', content: '', height: '2px', width: '100%', background: '#3498db', transform: 'scaleX(0)', transformOrigin: 'center', transition: 'transform 0.3s ease' }}></div>
            </div>
          </div>
