     ...
     {/* <KeyboardArrowRight /> */}
        ...
        <form style={{ padding: '30px 0 0 0' }}>
          ...
          <textarea
            ...
            cols="80"
            required
            style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', resize: 'none', paddingTop: '10px' }}
            defaultValue={""} // Set your initial value here
            onChange={(e) => console.log(e.target.value)} // Handle changes as needed
          ></textarea>
          <br />
