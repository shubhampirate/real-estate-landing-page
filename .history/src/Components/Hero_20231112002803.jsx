     ...
     {/* <KeyboardArrowRight /> */}
        ...
        <form style={{ padding: '30px 0 0 0' }}>
          ...
          <div style={{ width: '100%', height: '70px', position: 'relative' }} className="textarea">
            <textarea rows="8" cols="80" required style={{ display: 'block', width: '100%', height: '100%', border: 'none', fontSize: '17px', resize: 'none', paddingTop: '10px' }} placeholder="How can we help you ? Feel free to get in touch!"></textarea>
            <br />
