    ...
    <Box sx={{ mt: 5, background: "linear-gradient(#387FF5, #fff)", py: 10 }}>
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        <Grid item xs={6}>
          ...
          Navigate the financial landscape confidently with our tailored investment advice, ensuring your portfolio aligns with your goals. We prioritize your success, offering strategic insights for a secure and thriving financial future.   </Typography>
          </Item>
        </Grid>
        <Grid item xs={6}>
          <Item>
